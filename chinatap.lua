...
modelPaths = ui.MultiTextEntry(grp2, "Paths") local grp3 = ui.Group(t1, [[Viewmodel]]) cbVm = ui.CheckBox(grp3, "Enable") vmX = ui.Slider(grp3, "X", -10, 10, 0, 0.1)
...
"On Vote" }) end end local function getVM() if not cbVm:Get() then return 
